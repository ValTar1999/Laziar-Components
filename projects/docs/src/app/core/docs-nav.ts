  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        label: 'nav.items.languageDropdown',
        route: '/components/language-dropdown',
        kind: 'component',
        icon: 'language',
        keywords: 'language locale flag i18n',
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        id: 'toast',
        label: 'nav.items.toast',
        route: '/components/toast',
        kind: 'component',
        icon: 'bell-alert',
        keywords: 'toast notification toastservice snackbar',
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        id: 'card',
        label: 'nav.items.card',
        route: '/components/card',
        kind: 'component',
        icon: 'rectangle-stack',
        keywords: 'card article image title',
      },
      {
        id: 'table',
        label: 'nav.items.table',
        route: '/components/table',
        kind: 'component',
        icon: 'table-cells',
        keywords: 'table grid pagination rows',
      },
      {
        id: 'live-event-card',
        label: 'nav.items.liveEventCard',
        route: '/components/live-event-card',
        kind: 'component',
        icon: 'signal',
        keywords: 'live event coverage card',
      },
      {
        id: 'articlecard-reactions',
        label: 'nav.items.articlecardReactions',
        route: '/components/articlecard-reactions',
        kind: 'component',
        icon: 'face-smile',
        keywords: 'reactions emoji article',
      },
      {
        id: 'login-prompt-banner',
        label: 'nav.items.loginPromptBanner',
        route: '/components/login-prompt-banner',
        kind: 'component',
        icon: 'lock-closed',
        keywords: 'login prompt banner auth',
      },
      {
        id: 'auth-footer',
        label: 'nav.items.authFooter',
        route: '/components/auth-footer',
        kind: 'component',
        icon: 'document-text',
        keywords: 'auth footer about terms contacts',
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        label: 'nav.items.moreActionsMenu',
        route: '/components/more-actions-menu',
        kind: 'component',
        icon: 'ellipsis-horizontal',
        keywords: 'more actions menu kebab share',
      },
    ],
  },
  {
    id: 'media',
    label: 'nav.groups.media',
    items: [
      {
        id: 'swiper',
        label: 'nav.items.swiper',
        route: '/components/swiper',
        kind: 'component',
        icon: 'view-columns',
        keywords: 'swiper carousel slider slides',
      },
      {
        id: 'video-player',
        label: 'nav.items.videoPlayer',
        route: '/components/video-player',
        kind: 'component',
        icon: 'play-circle',
        keywords: 'video player videojs nuevo',
      },
    ],
  },
  {
